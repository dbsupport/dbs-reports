...
//	 */
//	private static final String LINE_SEPARATOR = PrivilegedAccessHelper
//			.getLineSeparator();
//
//	// ~ Members
//	// ----------------------------------------------------------------------------------------------------------
...
//
//		/*
//		 * Unsynchronized & sized character buffer to avoid too much array
//		 * resize operations :
//		 */
...
//			sb.append(space);
//			sb.append(AbstractSessionLog.CONNECTION_STRING).append(
//					PAR_OPEN_CHAR);
//			sb.append(
