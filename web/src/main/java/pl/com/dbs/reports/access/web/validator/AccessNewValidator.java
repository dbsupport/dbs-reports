...
public class AccessNewValidator implements Validator {
	...
	public boolean supports(Class<?> clazz) {
		return AccessNewForm.class.equals(clazz);
	}
	
	@Override
	public void validate(Object target, Errors errors) {
		AccessNewForm form = (AccessNewForm)target;
		...
		if (!m.matches()) errors.rejectValue("name", "access.new.name.invalid");
