...
<tiles:putAttribute name="id" type="string">dbs-page-access-new</tiles:putAttribute>
<tiles:putAttribute name="title" type="string">Nowe uprawnienie raportowe</tiles:putAttribute>
...
<tiles:putAttribute name="content" type="string">
                    	...
                    	<form:form method="post" modelAttribute="accessNewForm" action="access/new" class="dbs-form">
                            ...
                            <div class="wizard-actions">
                            	<button type="button" class="btn-glow" onclick="location.href='access/new'"><i class="icon-refresh"></i>&nbsp;Wyczyść</button><span>&nbsp;</span>
