...
<tiles:putAttribute name="id" type="string">dbs-page-profile-group-new</tiles:putAttribute>
<tiles:putAttribute name="title" type="string">Nowa grupa profilowa</tiles:putAttribute>
...
<form:form method="post" modelAttribute="profilegroupnewform" action="profile/group/new" class="dbs-form">
    ...
    <div class="wizard-actions">
        <button type="button" class="btn-glow" onclick="location.href='profile/group/new'"><i class="icon-refresh"></i>&nbsp;Wyczyść</button><span>&nbsp;</span>
