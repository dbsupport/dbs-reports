                    	...
                    	<form:form method="post" modelAttribute="reportPatternImportForm" action="report/pattern/import/write" class="new_user_form">
                    		<input type="hidden" name="page" value="2"/>
                    	 	...
                    	 	<div class="field-box">
                            	...
                            	<div class="col-md-12">
                                	<input class="form-control inline-input" type="text" readonly="readonly" value="${reportPatternImportForm.pattern.accessesAsString}"/>
                            	</div>
                        	</div>                        	
                    	 	<div class="field-box">
	                        ...
	                        <div class="field-box">
	                            ...
	                            <div class="col-md-9">
	                                <textarea class="form-control" rows="4" readonly="readonly"><c:out value="${reportPatternImportForm.pattern.manifest.text}"/></textarea>
	                            </div>
	                        </div>                        	
                            ...
                            <div class="col-md-11 field-box actions">
		                        ...
		                        <button type="submit" class="btn-glow success btn-finish">Zapisz szablon!</button><span>&nbsp;</span>                            
                            </div>
                        </form:form>
	                </div>
	                </div>
