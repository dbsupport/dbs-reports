...
<tiles:putAttribute name="title" type="string">Lista <c:if test="${current}"> Twoich </c:if>raportów archiwalnych</tiles:putAttribute>
...
<tiles:putAttribute name="form" type="string">
                <form:form method="post" modelAttribute="reportArchivesForm" action="report/archived" class="dbs-form">
...
<tiles:putAttribute name="content" type="string">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            <td>
                                <a href="report/archive/${report.id}/download" title="Podgląd">${report.name}</a>
                            </td>
                            <td>
                            ...
                            <td class="align-right">
	                            ...
	                            <li class="last"><a href="#" class="report-delete" data-url="report/archived/delete/${report.id}"><i class="table-delete" title="Usuń raport"></i></a></li>
	                            </sec:authorize>
	                            </ul>
                            </td>                             
                        </tr>
