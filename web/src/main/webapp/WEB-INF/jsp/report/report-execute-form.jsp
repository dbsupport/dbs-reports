        ...
        <div id="pad-wrapper" class="new-user">
            ...
            <div class="row form-wrapper">
                ...
                <div class="col-md-9 with-sidebar">
                    ...
                    <div class="row form-wrapper">
                    <div class="col-md-12">                
                    	<form:form method="post" modelAttribute="reportGenerationForm" action="report/execute/form" class="new_user_form">
                            ...
                            <div class="col-md-11 field-box actions">
                            	<button type="button" class="btn-glow" onclick="location.href='report/execute'"><i class="icon-refresh"></i>&nbsp;Wyczyść</button><span>&nbsp</span>
		                        <button type="submit" class="btn-glow primary btn-next" data-last="Finish">Dalej&nbsp;&nbsp;<i class="icon-chevron-right"></i><span>&nbsp</span>
		                        </button>                            
