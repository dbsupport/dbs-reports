        ...
        <div id="pad-wrapper" class="new-user">
            ...
            <div class="row form-wrapper">
                ...
                <div class="col-md-9 with-sidebar">
                    ...
                    <div class="row form-wrapper">
                    <div class="col-md-12">                
                    	<form:form method="post" modelAttribute="reportGenerationForm" action="report/execute/summary" class="new_user_form">
                            ...
                            <div class="col-md-11 field-box actions">
		                        <button type="submit" class="btn-glow primary btn-next" data-last="Finish">Zacznij od nowa!</button>                            
                            </div>
                        </form:form>
	                </div>
	                </div>
