    ...
    <div class="content" id="main-container">
		...
		<div id="pad-wrapper">
            ...
            <div class="row">
				...
				<c:set var="steps"><tiles:getAsString name="steps"/></c:set>
				<c:set var="step"><tiles:getAsString name="step"/></c:set>                
                
                	<c:if test="${!empty steps}">
                    <div id="fuelux-wizard" class="wizard row">
                        <ul class="wizard-steps">
                        <c:forTokens items="${steps}" var="item" delims=";" varStatus="rstatus">
                            <li data-target="#step${rstatus.count}"<c:if test="${rstatus.count eq step}"> class="active"</c:if>>
                                <span class="step">${rstatus.count}</span>
